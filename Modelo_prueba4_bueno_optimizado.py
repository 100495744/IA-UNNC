...
def run_pipeline():
    ...
    phases = [
        {"name": "1. Basic Structure", "seq": 32, "epochs": 4, "stride": 4},
        {"name": "2. Medium Coherence", "seq": 64, "epochs": 4, "stride": 2},
        {"name": "3. Final Polish (Slow but precise)", "seq": 128, "epochs": 10, "stride": 1}
    ]    
